...
public static class EmbeddedAssembly
{
	...
	public static void EmbeddedAssembliesInit()
	{
		...
		EmbeddedAssembly.Load("ShiftChanges.Microsoft.Exchange.WebServices.Auth.dll", "Microsoft.Exchange.WebServices.Auth.dll");
		EmbeddedAssembly.Load("ShiftChanges.Microsoft.Exchange.WebServices.dll", "Microsoft.Exchange.WebServices.dll");
