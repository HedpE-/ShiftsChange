...
namespace ShiftChanges
{
	public sealed class NotificationIcon
	{
		...
		System.Timers.Timer exchangePollsTimer;
...
//			EmbeddedAssembly.EmbeddedAssembliesInit();
		...
		private void startServiceClick(object sender, EventArgs e)
		{
			...
			exchangePollsTimer = new System.Timers.Timer(intervalInMs);
			exchangePollsTimer.Elapsed += midnightTimer_Elapsed;
			exchangePollsTimer.Enabled = true;
			midnightTimer_Elapsed(null, null);
		}
		...
		void midnightTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
		{
			...
			Folder exchangeFolder = getWorkingFolder();
			...
			FindItemsResults<Item> findResults = service.FindItems(exchangeFolder.Id, sf, itemview);
